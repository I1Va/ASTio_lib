...
-fno-omit-frame-pointer -Wlarger-than=16384 -Wstack-usage=8192 -pie -fPIE -Werror=vla\
...
#/---------------------------PROJECT_SRC_CONFIG--------------------\#
PROJECT_NAME = ASTio_lib
CSRC = main.cpp src/AST_proc.cpp src/AST_io.cpp
...
#/---------------------------SUBMODULES_CONFIG--------------------\#
SUBMODULES = string_funcs graphviz_funcs
#/---------------------------SUBMODULES_CONFIG--------------------\#
...
launch:
	@$(LAUNCH_PREFLAGS) ./$(OUT_O_DIR)/$(OUTFILE_NAME) $(LAUNCH_FLAGS)
